...
{
    public partial class InsertarAgregacion : Form
    {
        ...
        public InsertarAgregacion(object listaClases, object listaInterfaces, GraficaGrupo4 pnlPrincipal)
        {
            InitializeComponent();
        ...
        private void BtnCrear_Click(object sender, EventArgs e)
        {
            ...
            {
                //MessageBox.Show("\n\nentra a funcion\n\n");
                this.pnlPrincipal.agregarAgregacion(this.clase1, this.clase2);
                this.Close();
            }
            else
            {
