...
{
    public partial class InsertarDependencia : Form
    {
        ...
        public InsertarDependencia(object listaClases, object listaInterfaces, GraficaGrupo4 pnlPrincipal)
        {
            InitializeComponent();
        ...
        private void BtnCrear_Click(object sender, EventArgs e)
        {
            ...
            {
                //MessageBox.Show("\n\nentra a funcion\n\n");
                this.pnlPrincipal.agregarDependencia(this.clase1, this.clase2);
                this.Close();
            }
            else
            {
